...
sendpoint *scomponent::add_endpoint(const char *name, EndpointType type,
		HashCode *msg_hc, HashCode *reply_hc, int flexible_matching)
{
	...
	return do_add_endpoint(name, type, msg_hc_copy, reply_hc_copy, flexible_matching);
}
		...
		const char *msg_hash, const char *reply_hash, int flexible_matching)
{
	...
	return do_add_endpoint(name, type, msg_hc, reply_hc, flexible_matching);
}
		...
		HashCode *msg_hc, HashCode *reply_hc, int flexible_matching)
{
	...
	ep = new sendpoint(name, type, msg_hc, reply_hc, flexible_matching);
	...
	add->flexible_matching = flexible_matching;
		...
		HashCode *msg_hc, HashCode *reply_hc, int flexible_matching)
{
	...
	this->flexible_matching = flexible_matching;
