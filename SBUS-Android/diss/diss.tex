...
Word Count:         & \bf 2712\footnotemark[1] \\
...
The policy engine could subscribe to notifications from the AIRS gateway, allowing it to react to data from sensors on the device. 
