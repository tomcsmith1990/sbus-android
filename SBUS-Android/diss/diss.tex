...
The system currently faces issues with a rapidly changing context, for example, moving in and out of range of a Wi-Fi network. 
...
If this reconnection occurs before the disconnection has completed, the application believes itself to still be connected to the peer, thus will not create a new connection.
