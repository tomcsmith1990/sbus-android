...
% example
For example, when writing a transport application a developer should not need to write separate code to handle data about Virgin Trains and London Midland trains. 
...
Given the amount of uncertainty about what data will be available, the developer cannot hope to account for all possibilities.
