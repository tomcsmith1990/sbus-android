...
Word Count:         & \bf 2197\footnotemark[1] \\
...
This gives an application control over which data sources it can be connected to, but does not require the application to find the data sources itself. 
Upon a change in context, the system will reconfigure connections ensuring that they conform to these schema constraints allowing applications to continue receiving fresh data.
...
Since this subscription is specified in terms of the London Midland train schema, it will not function correctly if applied directly to the Virgin train schema. 
...
{\sl I think this section might be more obvious after writing the in Preparation chapter about how the project was planned. }
