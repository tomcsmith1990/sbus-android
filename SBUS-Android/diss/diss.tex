...
Word Count:         & \bf 9477\footnotemark[1] \\
...
If the component schema has additional ancestors, then these are removed from the filter, while if the target schema has additional ancestors, the filter is prepended with these, making the filter {\tt place/location/gps/latitude > 0.0}.
