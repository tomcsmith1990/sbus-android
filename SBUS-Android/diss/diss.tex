...
Different mobile environments mean that devices are operating in different contexts and scopes. 
...
However, this data source may have its scope limited to the network, so it becomes unavailable if we leave the network.
In other environments, proximity may be important, for example if we were exchanging data via Bluetooth. 
