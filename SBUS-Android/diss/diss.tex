...
Word Count:         & \bf 5796\footnotemark[1] \\
...
\item John enjoys visiting the local library, however is concerned that he may suffer a fall which will go unnoticed, since it is large and often empty.
