...
Word Count:         & \bf 4251\footnotemark[1] \\
...
In the second row, the transport application sets a policy for any component named ``Stagecoach'' which has an endpoint named ``Coach'', while in the third row it sets a policy for any component which has a structure matching the type of {\tt coach}. 
