...
Word Count:         & \bf 1219\footnotemark[1] \\
...
In some environments there may be Wi-Fi networks available, in which case it would be sufficient to use a data source from that network. 
...
Once this alternative data source has been found, the application must still determine whether it provides useful data. 
...
Applications on the device can register with this system, which then handles any reconfiguration necessary.
