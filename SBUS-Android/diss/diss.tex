...
\rownumber\label{tab:row:none} 				&	NONE			& NONE						& localhost				& NULL \\
...
This policy will be applied on any event, however this attempts to connect to the loopback address without any endpoint specified, so no connection is made. 
