...
Word Count:         & \bf 7502\footnotemark[1] \\
...
The toolchain setup did include a bug\footnote{https://code.google.com/p/android/issues/detail?id=35279} which meant some include paths were missing. 
...
In principle, the user's full name or username could be found in Java using the AccountManager class\footnote{http://developer.android.com/reference/android/accounts/AccountManager.html}, which could then be passed as a parameter to the component via JNI. 
