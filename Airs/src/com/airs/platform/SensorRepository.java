...
public class SensorRepository 
{
    ...
    static synchronized public void insertSensor(String Symbol, String Unit, String Description, String type, int scaler, int min, int max, boolean hasHistory, int poll)
    {
        // make copy of sensor object
        new_one = new Sensor(Symbol, Unit, Description, type, scaler, min, max, hasHistory, poll);
        // first sensor?
        if (root_sensor == null)
            root_sensor = new_one;
        else
